...
class Coach():
    ...
    in Game and NeuralNet. args are specified in main_old.py.
    """

    def __init__(self, game, nnet, args):
        self.game = game
        self.nnet = nnet
        self.pnet = self.nnet.__class__(self.game, self.nnet.net_args)  # the competitor network
        self.args = args
    ...
    def executeEpisode(self):
        ...
        while True:
            ...
            if r != 0:
                return [(x[0], x[2], r * ((-1) ** (x[1] != self.curPlayer))) for x in trainExamples], r
